				...
				<div class="col-12">
					<div class="site-navbar">
                        ...
                        <ul class="main-menu">
                            ...
                            <li><a href="#lahanparkir">Lahan Parkir</a></li>
                            <li><a href="about">Tentang</a></li>
							<li><a href="#tempatpopuler">Tempat Populer</a></li>
		...
		<section class="team-section spad pb-0">
			<div class="container">
				<div class="section-title text-center">
					<h3>TIM KAMI</h3>
					<p>Kami hanyalah mahasiswa yang masih belajar</p>
				</div>
				<div class="row">
					...
					<div class="col-lg-3 col-md-6">
						<div class="team-member">
							...
							<div class="member-info">
								<h5>Zanuar Ekaputra Rus'an</h5>
								<span>1177050123</span>
								<div class="member-contact">
									<p><i class="fa fa-phone"></i>(+62) 888 121 2243</p>
									<p><i class="fa fa-envelope"></i>zanuar@sewaparkir.com</p>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-md-6">
						<div class="team-member">
							...
							<div class="member-info">
								<h5>Agung Satrio Budi Prakoso</h5>
								<span>1177050008</span>
								<div class="member-contact">
									<p><i class="fa fa-phone"></i>(+62) 888 121 2288</p>
									<p><i class="fa fa-envelope"></i>agung@sewaparkir.com</p>
								</div>
							</div>
						</div>
					</div>
